...
declare function EntityRelationsWidget(props: EntityRelationsWidgetProps): React.JSX.Element;
declare function WrappedEntityRelationsWidget(props: EntityRelationsWidgetProps): React.JSX.Element;
