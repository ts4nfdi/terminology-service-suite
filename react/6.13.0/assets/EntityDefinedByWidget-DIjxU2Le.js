"use client";import{j as r}from"./iframe-HXQx_4aD.js";import{u as k}from"./useQuery-Cl797HID.js";import{O as E,E as w,g as O,a0 as I}from"./OlsEntityApi-B1nBw2KU.js";/* empty css                  */import{E as S}from"./EntityDefinedByPresentation-Cm8R-F8l.js";import{E as v}from"./text-DyKVXxjF.js";function L(c){const{iri:o,api:p,parameter:l,entityType:t,ontologyId:b,useLegacy:a,className:g}=c,m=new E(p),{data:s,isLoading:h,isSuccess:f,isError:u,error:T}=k(["entityDefinedBy",p,l,t,o,b,a],async()=>{let i,d,y;if(a){const e=(await m.getEntityResponse(o,t,void 0,l,a))._embedded;i=e[Object.keys(e)[0]].filter(n=>n.is_defining_ontology).map(n=>n.ontology_name),d=t||I(Object.keys(e)[0]),y=e[Object.keys(e)[0]][0].label}else{const e=await m.getEntityObject(o,t,b,l,a);i=e.getDefinedBy().filter(n=>n!=e.getOntologyId()),d=t||e.getType(),y=e.getLabel()||""}return i=i.sort(),{ontoList:i,entityType:d,label:y}});return r.jsxs("div",{"data-testid":"entity-defined-by",children:[f&&s&&r.jsx(S,{ontolist:s.ontoList,entityType:s.entityType,label:s.label,iri:o,onNavigateToOntology:c.onNavigateToOntology,className:g}),h&&r.jsx(w,{}),u&&r.jsx(v,{children:O(T,"ontology list")})]})}L.__docgenInfo={description:"",methods:[],displayName:"EntityDefinedByWidget",props:{api:{required:!0,tsType:{name:"string"},description:"The API instance for the API call."},entityType:{required:!1,tsType:{name:"unknown[number]",raw:"(typeof entityTypeNames)[number]"},description:"Sets the type of the entity whose information you want to fetch."},ontologyId:{required:!0,tsType:{name:"string"},description:"Select a specific ontology by id"},iri:{required:!0,tsType:{name:"string"},description:"Entity IRI whose information you want to fetch."},parameter:{required:!1,tsType:{name:"string"},description:`Additional parameters to pass to the API.
