...
@param entity.parents obtains the list of parent entities of the clicked entity (only OLS, Skosmos)`},shortForm:{required:!1,tsType:{name:"string"},description:""},entity:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  ...
  shortForm: string;
  [key: string]: any;
}`,signature:{properties:[{key:"ontologyId",value:{name:"string",required:!0}},{key:"shortForm",value:{name:"string",required:!0}},{key:{name:"string"},value:{name:"any",required:!0}}]},required:!0}}]}},description:""}}};export{m as B};
