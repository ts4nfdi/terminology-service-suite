...
`)},V=function(r){var o=r.euiTheme,n=r.highContrastMode,e={control:o.size.base,lineHeight:o.size.l,labelGap:o.size.s},a={unselected:o.components.forms.controlBackgroundUnselected,unselectedBorder:n?o.border.color:o.components.forms.controlBorder,selected:o.colors.primary,selectedBorder:o.components.forms.controlBorderSelected,selectedIcon:o.colors.emptyShade,disabled:o.components.forms.controlBackgroundDisabled,disabledBorder:o.components.forms.controlBorderDisabled,disabledIcon:o.components.forms.iconDisabled,disabledLabel:o.colors.textDisabled},c={speed:o.animation.fast,easing:"ease-in"};return{sizes:e,colors:a,animation:c}},q=function(r){var o=r.euiTheme,n=r.highContrastMode,e=V(r),a=f([e.sizes.lineHeight,e.sizes.control],function(c,u){return(c-u)/2});return{wrapper:`
    ...
    `,input:{fauxInput:`
      ...
      `)}}};export{q as a,V as b,s as c,O as d,$ as e,x as f,j as g,L as h};
