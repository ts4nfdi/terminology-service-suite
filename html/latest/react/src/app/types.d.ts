...
export type BreadcrumbPresentationProps = OptionalOntologyIdObj & ColorFirstObj & ColorSecondObj & CssClassNameObj & OnNavigateToOntology & {
    ontologyId?: string;
    shortForm?: string;
    entity?: {
        properties: {
...
export type MetadataCompactProps = Partial<Omit<EuiCardProps, "layout">> & ApiObj & TargetLinkObj & ParameterObj & CssClassNameObj & OptionalEntityTypeObj & {
