import{cC as H,j as l,cD as w,cE as _,cF as P,aD as E,aB as y,aG as j,cB as p,aJ as I,aH as B}from"./QueryClientProvider-C4FCUO2w.js";function h(n){"@babel/helpers - typeof";return h=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(o){return typeof o}:function(o){return o&&typeof Symbol=="function"&&o.constructor===Symbol&&o!==Symbol.prototype?"symbol":typeof o},h(n)}var D=function(o,r){return l.contrast(o,r)},F=4.5,z=function(o){var r=arguments.length>1&&arguments[1]!==void 0?arguments[1]:4.85;return function(t){var e,a=h(t)==="object"&&(e=H(t,o))!==null&&e!==void 0?e:o,i=h(t)==="object"?t.colors.body:t;(l(a).alpha()<1||l(i).alpha()<1)&&console.warn(`Contrast cannot be accurately calculated when colors have alpha channel opacity. Make sure the provided foreground and background colors have no transparency:
