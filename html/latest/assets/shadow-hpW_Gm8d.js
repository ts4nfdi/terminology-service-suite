import{c as l,cN as s}from"./storyArgs-CNybPO01.js";const $=(x,a,w)=>{const r=w===s.dark?a*3.5:a*1;return l(x).alpha(r).css()},d=({euiTheme:x,colorMode:a,highContrastMode:w},r)=>{if(w)return u(x,r);const c=(r==null?void 0:r.color)||x.colors.shadow;return`
box-shadow:
  0 .8px .8px ${$(c,.04,a)},
  0 2.3px 2px ${$(c,.03,a)};
