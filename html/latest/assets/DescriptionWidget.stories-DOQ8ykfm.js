import{b as f}from"./widgetDescriptions-MmE0nvU9.js";import{E as s,Z as O}from"./globals-Dr4u9m4r.js";import{c as S,P as I,p as W,v as E,u as b,y as $,R as v,S as P,j as w}from"./QueryClientProvider-B4L6wlZa.js";import"./index-DZf6RfkI.js";import"./client-DFp2fd_t.js";import"./DescriptionWidget-ComX01VW.js";import"./useQuery-oISZDfFl.js";import"./OlsThingApi-D6KDdK17.js";/* empty css                                */import"./text-CttJJIDi.js";import"./link.styles-_K5vrc9F.js";const{expect:x,waitFor:N,within:L}=__STORYBOOK_MODULE_TEST__,B={...w,...P,...v,...$,...b,...E,...W,...I,...S},F={api:"",iri:"",useLegacy:!0,ontologyId:"",thingType:"term",descText:"",color:"",className:"",parameter:""},U={iri:"http://purl.obolibrary.org/obo/NCIT_C2985",api:O,ontologyId:"ncit",thingType:"term"},M={api:s,iri:"http://purl.obolibrary.org/obo/IAO_0000631",thingType:"term",parameter:""},j={api:s,iri:"http://identifiers.org/uniprot/Q9VAM9",thingType:"term",parameter:""},C={api:s,iri:"http://identifiers.org/uniprot/Q9VA",thingType:"term",parameter:""},n=async({canvasElement:e})=>{const t=L(e);await N(async()=>{const h=t.getByTestId("description");await x(h).toBeInTheDocument()},{timeout:3e3})};let Q=0;function R(){return Q++}const ee={title:"Entity Metadata/DescriptionWidget",tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:f}}},render:e=>{const t=R();return`
...
<\/script>
        `},argTypes:B,args:F},r={args:U,play:n},o={args:M,play:n},i={args:j,play:n},a={args:C,play:n};var c,p,g;r.parameters={...r.parameters,docs:{...(c=r.parameters)==null?void 0:c.docs,source:{originalSource:`{
