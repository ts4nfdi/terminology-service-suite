...
import { createAlternativeNameTab, createBreadcrumb, createCrossRefTab, createDescription, createEntityDefinedBy, createEntityOntoList, createHierarchy, createIri, createMathFormula, createMetadata, createTab, createTitle } from './MetadataWidget';
