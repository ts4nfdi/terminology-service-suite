...
import { createMetadata, createTitle, createTab, createHierarchy, createBreadcrumb, createIri, createEntityOntoList, createEntityDefinedBy, createAlternativeNameTab, createDescription, createCrossRefTab } from './MetadataWidget';
export { createSearchBar, createDataContent, createAutocomplete, createEntityInfo, createEntityRelations, createGraphView, createJsonApi, createOntologyInfo, createResources, createSearchResultsList, createDepiction, createMetadata, createTab, createHierarchy, createCrossRefTab, createAlternativeNameTab, createBreadcrumb, createDescription, createEntityDefinedBy, createEntityOntoList, createIri, createTitle, };
