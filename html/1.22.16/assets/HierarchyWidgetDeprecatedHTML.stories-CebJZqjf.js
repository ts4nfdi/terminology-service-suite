import"./semlookp_widgets.min-BJPtwCpy.js";const r={api:{description:"Instance of the OLS API to call.",control:{type:"radio"},options:["https://www.ebi.ac.uk/ols4/api/","https://semanticlookup.zbmed.de/ols/api/","https://semanticlookup.zbmed.de/api/"]},ontologyId:{description:"Ontology ID from where the term hierarchy should be taken."},iri:{description:"Iri of the term you want to fetch the term hierarchy for."},parameter:{collection:"nfdi4health"}},o={iri:"",ontologyId:""},d={args:{iri:"http://purl.bioontology.org/ontology/MESH/D003704",api:"https://semanticlookup.zbmed.de/api/",ontologyId:"mesh",parameter:"nfdi4health"}};let i=0;function a(){return i++}const n={title:"HierarchyWidgetDeprecated",tags:["autodocs"],parameters:{layout:"centered"},render:e=>{const t=a();return`
