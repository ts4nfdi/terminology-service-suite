import{bA as H,bu as M,bs as T,bc as q,aN as b,aO as l,e as x,bL as O,aP as v}from"./storyArgs-CNybPO01.js";import{m as L}from"./_button-YkQj8NM0.js";var y,w;function U(){if(w)return y;w=1;var n=H(),r=M(),o="[object Symbol]";function t(e){return typeof e=="symbol"||r(e)&&n(e)==o}return y=t,y}var C,F;function G(){if(F)return C;F=1;function n(r,o){for(var t=-1,e=r==null?0:r.length,a=Array(e);++t<e;)a[t]=o(r[t],t,r);return a}return C=n,C}var S,z;function W(){if(z)return S;z=1;var n=T(),r=G(),o=q(),t=U(),e=n?n.prototype:void 0,a=e?e.toString:void 0;function c(i){if(typeof i=="string")return i;if(o(i))return r(i,c)+"";if(t(i))return a?a.call(i):"";var d=i+"";return d=="0"&&1/i==-1/0?"-0":d}return S=c,S}var k,B;function to(){if(B)return k;B=1;var n=W();function r(o){return o==null?"":n(o)}return k=r,k}function h(n){"@babel/helpers - typeof";return h=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(r){return typeof r}:function(r){return r&&typeof Symbol=="function"&&r.constructor===Symbol&&r!==Symbol.prototype?"symbol":typeof r},h(n)}function P(n,r){var o=Object.keys(n);if(Object.getOwnPropertySymbols){var t=Object.getOwnPropertySymbols(n);r&&(t=t.filter(function(e){return Object.getOwnPropertyDescriptor(n,e).enumerable})),o.push.apply(o,t)}return o}function p(n){for(var r=1;r<arguments.length;r++){var o=arguments[r]!=null?arguments[r]:{};r%2?P(Object(o),!0).forEach(function(t){V(n,t,o[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(n,Object.getOwnPropertyDescriptors(o)):P(Object(o)).forEach(function(t){Object.defineProperty(n,t,Object.getOwnPropertyDescriptor(o,t))})}return n}function V(n,r,o){return(r=E(r))in n?Object.defineProperty(n,r,{value:o,enumerable:!0,configurable:!0,writable:!0}):n[r]=o,n}function E(n){var r=$(n,"string");return h(r)=="symbol"?r:r+""}function $(n,r){if(h(n)!="object"||!n)return n;var o=n[Symbol.toPrimitive];if(o!==void 0){var t=o.call(n,r);if(h(t)!="object")return t;throw new TypeError("@@toPrimitive must return a primitive value.")}return(r==="string"?String:Number)(n)}var N=function(r){var o=r.euiTheme;return o.components.forms.maxWidth},m=function(r){var o=r.euiTheme,t=r.highContrastMode,e=t?o.colors.emptyShade:o.components.forms.background,a=o.size.xxl,c=o.size.xl,i={maxWidth:N(r),controlHeight:a,controlCompressedHeight:c,controlPadding:o.size.m,controlCompressedPadding:o.size.s,controlBorderRadius:o.border.radius.medium,controlCompressedBorderRadius:o.border.radius.small,iconAffordance:b(o.size.base,function(s){return s*1.5}),iconCompressedAffordance:b(o.size.m,function(s){return s*1.5}),stateUnderlineHeight:t?b(o.border.width.thick,function(s){return s*2}):o.border.width.thick},d={textColor:o.colors.textParagraph,textColorDisabled:o.components.forms.colorDisabled,backgroundColor:e,backgroundDisabledColor:o.components.forms.backgroundDisabled,backgroundReadOnlyColor:o.components.forms.backgroundReadOnly,borderColor:t?o.border.color:o.components.forms.border,controlDisabledColor:o.components.forms.controlBackgroundDisabled,controlBoxShadow:"0 0 transparent",controlPlaceholderText:L(o.colors.textSubdued)(e),appendPrependBackground:o.components.forms.prependBackground},g={controlLayoutGroupInputHeight:b(a,function(s){return s-2}),controlLayoutGroupInputCompressedHeight:b(c,function(s){return s-2}),controlLayoutGroupInputCompressedBorderRadius:o.border.radius.small},f={controlIconSize:{s:o.size.m,m:o.size.base,l:o.size.l,xl:o.size.xl,xxl:o.size.xxl}};return p(p(p(p(p({},i),d),f),g),{},{animationTiming:"".concat(o.animation.fast," ease-in")})},ao=function(r){var o=m(r);return{shared:`
      `.concat(K(r),`
      `).concat(J(r),`
    `),uncompressed:`
    ...
    `),fullWidth:`
      ...
      `).concat(l("width","100%"),`
    `),invalid:X(r),focus:Q(r),disabled:Y(r),readOnly:Z(r),autoFill:oo(r)}},K=function(r){var o=r.euiTheme,t=x(r,"s"),e=t.fontSize,a=m(r);return`
    ...
    `).concat(D(`
      ...
      opacity: 1;
    `)),`
  `)},J=function(r){var o=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},t=o.withBorder,e=t===void 0?!0:t,a=o.withBackground,c=a===void 0?!0:a,i=o.withBackgroundColor,d=i===void 0?c:i,g=o.withBackgroundAnimation,f=g===void 0?c:g,s=r.euiTheme,u=m(r),_=v(r,{none:`
      border: none;
  ...
  `)},oo=function(r){var o=r.euiTheme,t=o.colors.darkestShade,e=o.components.forms.backgroundAutofilled,a="inset 0 0 0 100vw ".concat(e),c=o.components.forms.borderAutofilled,i=o.colors.danger,d=function(f){return"inset 0 0 0 ".concat(o.border.width.thin," ").concat(f)};return`
    &:-webkit-autofill {
  ...
  `)},I=function(r,o){if(r.highContrastMode!=="forced")return"background-size: 100% 100%;";var t=encodeURIComponent(o),e="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='100%25' height='100%25' fill='".concat(t,"' /%3E%3C/svg%3E"),a=m(r),c=a.stateUnderlineHeight;return`
...
`)},ro=function(r){var o=r.euiTheme,t=r.highContrastMode,e={control:o.size.base,lineHeight:o.size.l,labelGap:o.size.s},a={unselected:o.components.forms.controlBackgroundUnselected,unselectedBorder:t?o.border.color:o.components.forms.controlBorder,selected:o.colors.primary,selectedBorder:o.components.forms.controlBorderSelected,selectedIcon:o.colors.emptyShade,disabled:o.components.forms.controlBackgroundDisabled,disabledBorder:o.components.forms.controlBorderDisabled,disabledIcon:o.components.forms.iconDisabled,disabledLabel:o.colors.textDisabled},c={speed:o.animation.fast,easing:"ease-in"};return{sizes:e,colors:a,animation:c}},co=function(r){var o=r.euiTheme,t=r.highContrastMode,e=ro(r),a=b([e.sizes.lineHeight,e.sizes.control],function(c,i){return(c-i)/2});return{wrapper:`
      display: flex;
    ...
    `,input:{fauxInput:`
      ...
      `)}}};export{to as a,G as b,ro as c,ao as d,co as e,m as f,N as g,K as h,J as i,U as r};
