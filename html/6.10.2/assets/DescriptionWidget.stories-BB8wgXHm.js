import{c as f,X as O,p as I,v as S,u as W,y as E,Y as $,Z as b,i as v,_ as w}from"./QueryClientProvider-DoKhBl31.js";import{Z as x,E as s}from"./globals-BQAFDkgj.js";import"./index-Ck4utSAf.js";import"./client-hNkKQuBU.js";import"./DescriptionWidget-BjNqsXjN.js";import"./useQuery-BUxAEVUP.js";import"./OlsThingApi-CgqF9Ser.js";/* empty css                                */import"./text-D1HJ6Q9S.js";import"./link.styles-YP6iW4HB.js";const{expect:N,waitFor:P,within:L}=__STORYBOOK_MODULE_TEST__,B={...v,...b,...$,...E,...W,...S,...I,...O,...f},F={api:"",iri:"",useLegacy:!0,ontologyId:"",thingType:"term",descText:"",color:"",className:"",parameter:"collection=nfdi4health"},U={iri:"http://purl.obolibrary.org/obo/NCIT_C2985",api:x,ontologyId:"ncit",thingType:"term",parameter:"collection=nfdi4health"},M={api:s,iri:"http://purl.obolibrary.org/obo/IAO_0000631",thingType:"term",parameter:""},Z={api:s,iri:"http://identifiers.org/uniprot/Q9VAM9",thingType:"term",parameter:""},C={api:s,iri:"http://identifiers.org/uniprot/Q9VA",thingType:"term",parameter:""},n=async({canvasElement:e})=>{const t=L(e);await P(async()=>{const _=t.getByTestId("description");await N(_).toBeInTheDocument()},{timeout:3e3})};let Q=0;function V(){return Q++}const J={title:"Entity Metadata/DescriptionWidget",tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:w}}},render:e=>{const t=V();return`
