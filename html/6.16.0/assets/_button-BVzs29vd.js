import{co as _,j as l,cp as w,cq as H,cr as P,ao as j,am as y,ar as E,cn as p,au as I,as as B}from"./QueryClientProvider-zfE1X_HG.js";function h(n){"@babel/helpers - typeof";return h=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(o){return typeof o}:function(o){return o&&typeof Symbol=="function"&&o.constructor===Symbol&&o!==Symbol.prototype?"symbol":typeof o},h(n)}var D=function(o,r){return l.contrast(o,r)},F=4.5,z=function(o){var r=arguments.length>1&&arguments[1]!==void 0?arguments[1]:4.85;return function(t){var e,a=h(t)==="object"&&(e=_(t,o))!==null&&e!==void 0?e:o,i=h(t)==="object"?t.colors.body:t;(l(a).alpha()<1||l(i).alpha()<1)&&console.warn(`Contrast cannot be accurately calculated when colors have alpha channel opacity. Make sure the provided foreground and background colors have no transparency:
