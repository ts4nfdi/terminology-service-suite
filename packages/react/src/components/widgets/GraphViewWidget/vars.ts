export const ValidDirections = ["LR", "RL", "DU", "UD"];
export const SUBCLASS_OF_URIS = [
...
export const COMMON_NODES_BG_COLOR = "#ff991c";
export const NODE_TEXT_COLOR = "white";
export const DEFAULT_HIERARCHY_DIRECTION = "DU";
