import {classTypeNames, EntityTypeName, isClassTypeName, isIndividualTypeName} from "../../model/ModelTypeCheck";
import {Entity} from "../../model/interfaces";
import {asArray, getEntityInOntologySuffix, getUseLegacy, pluralizeType} from "../../app/util";
import {buildOtherParams, check_for_errors, isTop} from "../../utils/olsApiUtils";
    ...
    public async buildHierarchyWithEntity(
        ...
        if (preferredRoots) {
            const preferredRootEntities = (
                await this.ontologyService.getOntologyObject(ontologyId, undefined, useLegacy)
            ).getPreferredRoots();
