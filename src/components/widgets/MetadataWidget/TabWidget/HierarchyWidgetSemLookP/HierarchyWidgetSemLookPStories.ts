...
import {HIERARCHY_WIDGET_SEMLOOKP_DEFAULT_VALUES} from "./HierarchyWidgetSemLookP";

export const HierarchyWidgetSemLookPStoryArgTypes = {
    apiUrl: {},
    backend_type: {
        control: {
            type: "radio"
...
export const HierarchyWidgetSemLookPStoryArgs = {
    apiUrl: {},
    backend_type: {},
    apikey: {},
