...
import {OntologyHierarchyWidget, OntologyHierarchyWidgetProps} from './OntologyHierarchyWidget'
...
const Template = (args: OntologyHierarchyWidgetProps) => <OntologyHierarchyWidget {...args}/>
