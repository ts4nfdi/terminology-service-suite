...
function createBreadcrumbPresentation(
    props: BreadcrumbWidgetProps,
    container: Element,
    callback?: () => void
) {
  ReactDOM.render(WrappedBreadcrumbPresentation(props), container, callback);
}
...
export { BreadcrumbPresentation, createBreadcrumbPresentation };