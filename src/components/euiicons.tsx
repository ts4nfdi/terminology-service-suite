// Why this file? Vite seems to have issues with dynamically loading EUI icons
// This file exports a register function to all used icons
//
// https://github.com/elastic/eui/tree/main/wiki/consuming-eui#failing-icon-imports
// proposed solution: https://github.com/elastic/eui/issues/5463#issuecomment-1107665339

import { appendIconComponentCache } from "@elastic/eui/es/components/icon/icon";

// https://github.com/elastic/eui/blob/main/packages/eui/src/components/icon/icon_map.ts
...
export const registerDefaultIcons = () => {
...
export default registerDefaultIcons;