...
>
    ...
    <div style={{ display: 'flex', alignItems: 'center' }}>
        <img
            src="https://raw.githubusercontent.com/nfdi4health/semlookp-widgets/main/img/TS4NFDI-small-white.svg"
            alt="TS4NFDI Logo"
...
<p style={{ fontSize: 18 }}><b>Documentation:</b> [All Versions](https://terminology.services.base4nfdi.de/tss/)</p>

<p style={{ fontSize: 18 }}><b>Recent versions:</b></p>
<p style={{ fontSize: 18 }}><b>React NPM package (from v5.0.0):</b> [Latest](https://www.npmjs.com/package/@ts4nfdi/terminology-service-suite?activeTab=readme)</p>
<p style={{ fontSize: 18 }}><b>JavaScript NPM package:</b> [Latest](https://www.npmjs.com/package/@ts4nfdi/terminology-service-suite-js)</p>

<p style={{ fontSize: 18 }}><b>Older versions:</b></p>
...
<p style={{ fontSize: 18 }}><b>JavaScript modules (up to v5.5.0):</b> [Latest](https://github.com/ts4nfdi/terminology-service-suite/tree/gh-pages/js-modules/latest), [All Versions](https://github.com/ts4nfdi/terminology-service-suite/tree/gh-pages/js-modules)</p>
...
<div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap' }}>
    ...
    <div style={{ flex: '1 1 50px', marginRight: '20px' }}>
        <a href="https://storybook.js.org/" target="_blank" rel="noopener noreferrer">
            <img src="https://raw.githubusercontent.com/nfdi4health/semlookp-widgets/main/img/storybook-icon-svgrepo-com.svg" alt="Storybook Logo" width="200" />
        </a>
    </div>
</div>
