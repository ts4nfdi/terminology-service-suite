...
<div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap' }}>
    <div style={{ flex: '1 1 500px', marginRight: '40px'  }}>
        ...
        <p style={{fontSize:18}}>Click <a href="https://nfdi4health.github.io/semlookp-widgets/" target="_blank" rel="noopener noreferrer">here</a> for documentation on the different versions.</p>
        <p style={{fontSize:18}}><strong>The widgets are currently under active development. Please forgive any errors that occur and report issues via [GitHub Issue](https://github.com/nfdi4health/semlookp-widgets/issues)</strong>.</p>
    </div>
    <div style={{ flex: '1 1 350px', marginRight: '20px' }}>
        <img src="https://raw.githubusercontent.com/nfdi4health/semlookp-widgets/main/img/TS4NFDI_Logo.svg" width="500" />
    </div>
</div>

<p style={{ fontSize: 18 }}><b>Documentation:</b> [All Versions](https://nfdi4health.github.io/semlookp-widgets/)</p>
<p style={{ fontSize: 18 }}><b>React package:</b> [Latest](https://github.com/nfdi4health/semlookp-widgets/pkgs/npm/semlookp-widgets), [All Versions](https://github.com/nfdi4health/semlookp-widgets/pkgs/npm/semlookp-widgets/versions)</p>
<p style={{ fontSize: 18 }}><b>JavaScript modules:</b> [Latest](https://github.com/nfdi4health/semlookp-widgets/tree/gh-pages/js-modules/latest), [All Versions](https://github.com/nfdi4health/semlookp-widgets/tree/gh-pages/js-modules)</p>
...
<p style={{fontSize:18}}>For development, please see the [GitHub README](https://github.com/nfdi4health/semlookp-widgets).</p>
...
<p style={{fontSize:18}}>You can find a demo project [here](https://github.com/nfdi4health/semlookp-widgets-demo).</p>
...
<p style={{fontSize:18}}>You can find a demo project [here](https://github.com/ts4nfdi/JS-Widgets-Demo-Project).</p>
...
<ol>
    ...
    <li style={{fontSize:18}}>To use the widgets in an HTML file, you can either download the modules or use links and embed them in the appropriate tags in the head of the file. You can also include a link to an Elastic UI stylesheet.</li>
        <ul>
            <br></br>
            <li style={{fontSize:18}}>The plainJS module and CSS files can be found [here](https://github.com/nfdi4health/semlookp-widgets/tree/gh-pages/js-modules). Download and place in your project (see [Demo project](https://github.com/ts4nfdi/JS-Widgets-Demo-Project/tree/main/js)).</li>
            <br></br>
            ```html
            <head>
            ...
            <head>
                <link rel="stylesheet" href="https://unpkg.com/@elastic/eui@62.2.4/dist/eui_theme_light.css">
                <link rel="stylesheet" href="https://nfdi4health.github.io/semlookp-widgets/js-modules/1.22.17/semlookp_widgets.min.css">
                <script type="text/javascript" src="https://nfdi4health.github.io/semlookp-widgets/js-modules/1.22.17/semlookp_widgets.min.js"></script>
            </head>
            ```
            <br></br>
        </ul>
    <li style={{fontSize:18}}>An empty container with an id must be created. This container can then be referenced in a script tag where the SemLookP widget can now be rendered using the appropriate function added to `window['SemLookPWidgets']`. Here's a sample snippet:</li>
    <br></br>
    ```html
    <body>
