...
<p style={{ fontSize: 18 }}><b>React package NPM (since v5.0.0):</b> [Latest](https://www.npmjs.com/package/@ts4nfdi/terminology-service-suite?activeTab=readme)</p>
...
<p style={{ fontSize: 18 }}><b>React package GitHub:</b> [Latest](https://github.com/ts4nfdi/terminology-service-suite/pkgs/npm/terminology-service-suite), [All Versions](https://github.com/ts4nfdi/terminology-service-suite/pkgs/npm/terminology-service-suite/versions)</p>
...
<p style={{fontSize:18}}>This package is published at NPM (since v5.0.0) and at GitHub.</p>
