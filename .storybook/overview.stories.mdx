...
<p style={{ fontSize: 18 }}><b>React package:</b> [Latest](https://github.com/ts4nfdi/terminology-service-suite/pkgs/npm/terminology-service-suite), [All Versions](https://github.com/ts4nfdi/terminology-service-suite/pkgs/npm/terminology-service-suite/versions)</p>
...
<p style={{fontSize:18}}>For development, please see the [GitHub README](https://github.com/ts4nfdi/terminology-service-suite).</p>

### Installation

<p style={{fontSize:18}}>This package is published as source code and compiled as a [npm package](https://github.com/ts4nfdi/terminology-service-suite/releases) on [GitHub.com](https://github.com/ts4nfdi/terminology-service-suite). To install the package, you need to authenticate to GitHub.com. Detailed documentation on this topic can be found [here](https://docs.github.com/en/packages/working-with-a-github-packages-registry/working-with-the-npm-registry#authenticating-with-a-personal-access-token).</p>
...
<p style={{fontSize:18}}>You can find a demo project [here](https://github.com/ts4nfdi/react-widgets-demo-project).</p>
